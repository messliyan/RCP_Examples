...
class ItemDescriptor {
	...
	private Image  icon;
	private String view;	//view节点
	private String mainType;
	private String editor;	//editor节点
	...
	public ItemDescriptor(String id, String name, String description,
		Image icon, String view, String mainType,String editorId,String inputclass,
		String pluginId,IConfigurationElement element) {
		this.id = id;
		this.name = name;
	 ...
	 * @return an instance of the extension's specified type or <code>null</code>
	 */
	public Object createEdtorInputItem() throws CoreException {
		if (element == null) return null;
		return element.createExecutableExtension(LauncherPlugin.LAUNCH_ITEMS_XML_EDITOR_EDITORINPUT);
	}
	...
	/**
	 * Returns the host editor for the program.
	 * 
	 * @return the host view, null if the item is a standalone program.
	 */
	...
	//返回此节点的描述符是否为文件夹	mainType为空 且 view为空的时候为文件夹 
	public boolean isFolder() {
		return (mainType == null && view == null&&editor == null);
	}
