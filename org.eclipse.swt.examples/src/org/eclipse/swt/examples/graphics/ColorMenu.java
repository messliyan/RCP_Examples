...
public class ColorMenu {
	...
	private void addPatternItems(Menu menu, MenuItemListener menuListener,
		...
		Image[] images = new Image[]{
			loadImage(display, "pattern1.jpg", arrayList),	
			loadImage(display, "pattern2.jpg", arrayList),
			loadImage(display, "pattern3.jpg", arrayList),
		};
	 ...
	 */
	private Image loadImage(Display display, String name, ArrayList<Resource> arrayList) {
		Image image = GraphicsExample.loadImage(display, GraphicsExample.class, name);
		if (image != null) arrayList.add(image);
		return image;
	}
