...
void open(String name) {
	...
	if (!file.exists()) {
		String message = MessageFormat.format(resources.getString("Err_file_no_exist"), (Object)new String[] {file.getName()});
	...
	try {
		...
		try {
			...
			// Err_file_io
			String message = MessageFormat.format(resources.getString("Err_file_io"), (Object)new String[] {file.getName()});
			displayError(message);
			return;
		}
	}
	catch (FileNotFoundException e) {
		String message = MessageFormat.format(resources.getString("Err_not_found"), (Object)new String[] {file.getName()});
		displayError(message);
		return;
	}
